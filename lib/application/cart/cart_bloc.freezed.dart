...
abstract class _AddToCart implements CartEvent {
  const factory _AddToCart({required final Product product}) = _$AddToCartImpl;
...
class _$CartStateImpl implements _CartState {
  const _$CartStateImpl({required this.cart});
...
abstract class _CartState implements CartState {
  const factory _CartState({required final Cart cart}) = _$CartStateImpl;
